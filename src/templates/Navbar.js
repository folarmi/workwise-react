  ...
  return (
    <div className="object-cover flex items-center justify-between ">
      <div className="lg:flex lg:items-center">
        <Link to="/">
          <img src={image} alt="logo" className="w-1/2 lg:w-3/12" />
        </Link>
        <section className="hidden lg:block lg:-ml-32">
          <ul className="flex items-center" style={{ color: navLinkColor }}>
            ...
            <Link to="/login">
              <button
                class="bg-white focus:outline-none text-primary border border-primary font-extrabold text-sm py-4 px-14 font-verybold mr-4 rounded-md"
            ...
            <Link to="/tryforfree">
              <button
                class="bg-primary focus:outline-none text-white nav-links font-verybold font-semibold py-4 px-8 rounded-md"
